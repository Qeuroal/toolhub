...
local colors = {
  --{{{> Qeuroal
  text_default          = { bg = '#363a4f', fg = '#b8c0e0' },
  text_hover            = { bg = '#5b6078', fg = '#cad3f5' },
  text_active           = { bg = '#8aadf4', fg = '#11111b' },

  unseen_output_default          = { bg = '#363a4f', fg = '#eed49f' },
  unseen_output_hover            = { bg = '#5b6078', fg = '#eed49f' },
  unseen_output_active           = { bg = '#8aadf4', fg = '#eed49f' },

  scircle_default                = { bg = 'rgba(36, 39, 58, 0.4)', fg = '#363a4f' },
  scircle_hover                  = { bg = 'rgba(36, 39, 58, 0.4)', fg = '#5b6078' },
  scircle_active                 = { bg = 'rgba(36, 39, 58, 0.4)', fg = '#8aadf4' },

  progress_percentage_default    = { bg = '#363a4f', fg = '#9df296' },
  progress_percentage_hover      = { bg = '#5b6078', fg = '#9df296' },
  progress_percentage_active     = { bg = '#8aadf4', fg = '#9df296' },

  progress_error_default         = { bg = '#363a4f', fg = '#fa3970' },
  progress_error_hover           = { bg = '#5b6078', fg = '#fa3970' },
  progress_error_active          = { bg = '#8aadf4', fg = '#fa3970' },

  progress_indeterminate_default = { bg = '#363a4f', fg = '#f5e0dc' },
  progress_indeterminate_hover   = { bg = '#5b6078', fg = '#f5e0dc' },
  progress_indeterminate_active  = { bg = '#8aadf4', fg = '#f5e0dc' },
  --<}}}
}
