...
- #### Steps:
  ...
  1.  ```sh
      ...
      git clone https://github.com/qeuroal/toolhub.git
      ln -sf "toolhub/wezterm" ~/.config/wezterm
      ```
  2.  And Done!!! 🎉🎉
...
| <kbd>SUPER_REV</kbd>+<kbd>f</kbd> | `SpawnTab` <sub>(wsl:archlinux)</sub>    |
...
| <kbd>SUPER_REV</kbd>+<kbd>b</kbd> | Toggle background focus mode |
